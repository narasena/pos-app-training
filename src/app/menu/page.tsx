    ...
    const menus = [
        {
            ...
            items: [
                {
                    imgUrl: "https://mykoreankitchen.com/wp-content/uploads/2016/04/2.-Jjampong-500x375.jpg",
                    dishName: "Spicy seasoned seafood noodles",
                    price: 2.29,
                    stock: 20
                },
                {
                    imgUrl: "https://www.cucinabyelena.com/wp-content/uploads/2025/01/Creamy-Mushroom-Pasta-Recipe-21.jpg",
                    dishName: "Salted pasta with mushroom sauce",
                    price: 2.69,
                    stock: 11
                },
                {
                    imgUrl: "https://www.marionskitchen.com/wp-content/uploads/2019/12/Mushroom-Dumpling-Hot-Sour-Soup2.jpg",
            ...
            <div className="px-4 mt-4">
                ...
                <div className="grid grid-cols-5 gap-5">
                    {menus.find(menu => menu.type === activeTab)?.items.map((item, index) => (
                        <div key={index} className="bg-formbg flex flex-col gap-1 items-center text-white">
                            {item.imgUrl !== "" ? (
